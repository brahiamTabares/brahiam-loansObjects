...
public class ClienteParserUtil {
	...
	public static String toString(Cliente cliente) {
		...
		return cliente.getNombre() + SEPARADOR + cliente.getTipoDocumento() + SEPARADOR + cliente.getNumeroDocumento()
				...
				+ cliente.getDireccion() + SEPARADOR + cliente.getCiudadR() + SEPARADOR + cliente.getDepartamento()
				+ SEPARADOR + cliente.getPais() + SEPARADOR + cliente.getProfesion() + SEPARADOR + cliente.getEmail();
	...
	public static Cliente parse(String texto) {
		...
		Cliente cliente = new Cliente(arreglo[0], arreglo[1], arreglo[2], arreglo[3], arreglo[4], arreglo[5],
				arreglo[6], arreglo[7], arreglo[8], arreglo[9], arreglo[10]);
		return cliente;
	}
}
